...
public class homepage extends AppCompatActivity {
    ...
    activitylist = new ArrayList<>();
        ...
        activitymodel = new Activitymodel("2020愛您愛你 奔跑吧！毛小孩公益路跑","您是否也希望帶著心愛的毛小孩可以常常到外面走走，一起創造你與毛小孩的美好回憶呢? 延續2019/4/27及10/19的「奔跑吧！毛小孩公益路跑系列活動」，第三場我們將改善PHOTOVIP 降價再加派專業攝影師7位，讓您美好相片載不完!",R.drawable.act2);
        activitylist.add(activitymodel);

        activitymodel = new Activitymodel("2020 展昭台北寵物用品展","本次展出項目：寵物乾式及半乾式食品、零食點心、各式流行服飾配件、專業美容護理產品及居家衛生用品、外出相關配件、醫療保健用品等多項商品",R.drawable.act3);
        activitylist.add(activitymodel);

        activitymodel = new Activitymodel("上聯台北寵物用品博覽會","匯集全台各大寵物用品廠商提供最新寵物用品、美容清潔、住宿醫療等週邊服務。歡迎所有寵物愛好者攜帶寵物一同入場參觀！除了提供年度最優惠的商品促銷外，展出期間也邀請多家動保團體、動物相關慈善機構一同參與，集合大眾的力量一同為動物保護盡一份心力！",R.drawable.act4);
        activitylist.add(activitymodel);
        ...
        activitymodel = new Activitymodel("狗狗多久需要洗一次澡？","狗狗皮膚構造有2~5層，且皮膚本身雖然沒有汗腺，但卻會分泌保護皮毛的分泌物，過度清洗的話容易破壞這部分的組織。而狗狗多久需要洗一次澡，其實並沒有硬性規定，需要依品種、膚質及生活狀況不同來判斷洗澡的頻率。（大多為一週一次至一個月一次）",R.drawable.hea03);
        activitylist.add(activitymodel);
